...
import whatsapp from "@/assets/images/whatsapp.jfif";
...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "53d5439e-d096-470c-adba-601824546baa"); // Replace with your Web3Forms access key
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">abdullahzordok@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  <div className="bg-pink-500/10 p-3 rounded-lg">
                    <a href={`https://wa.me/201091155974?text=Hello%2C%20I'm%20interested%20in%20your%20services`} target="true">
                      <FaWhatsapp className="w-6 h-6 text-pink-400" />
                      {/* <img
                        className="h-7 w-fit"
                        src={whatsapp}
                        alt=""
