...
const profile = {
    ...
    skills: [
        ...
        'SQL', 'MongoDB', 'Docker', 'C#', 'TypeScript',
        'ASP.Net Core', 'API', 'Git', 'OOP'
    ],
    hardWorker: true,
    quickLearner: true,
    problemSolver: true,
            ...
            <div className="w-full lg:w-1/2 mb-12 lg:mb-0 animate__animated animate__fadeInLeft relative">
              ...
              <div className="relative mb-8 sm:mb-12 max-w-xl">
                <p className="text-base sm:text-xl text-gray-300/90 leading-relaxed">
                  Work at FoxMind Tech Ltd ( UK ) | JavaScript lover 🚀 | Angular frameworks
              ...
              <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 animate__animated animate__fadeInUp animate__delay-2s">
                ...
                <a
                  href="https://github.com/abdullah-zordok"
                ...
                {/* Contact Button */}
                <a
                  href="https://drive.google.com/file/d/18OAcrBU_UdsJeuId5YHI1wWvz0VsVHBX/view?usp=drive_link"
